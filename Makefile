CORE = core/Fichier.cpp core/CaseSalle.cpp core/Salle.cpp core/Zone.cpp core/Jeu.cpp core/ZoneGen.cpp core/Perso.cpp core/Modele.cpp core/SalleGen.cpp core/Coord2D.cpp core/VecteurM.cpp core/ModeleSalle.cpp
