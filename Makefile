...
SRCS_SFML = $(CORE) sfml/mainSFML.cpp sfml/JeuSFML.cpp sfml/CaseSFML.cpp sfml/CarteAffSFML.cpp sfml/TextureSFML.cpp sfml/PersoSFML.cpp sfml/SelecPersoSFML.cpp sfml/ProjectileSFML.cpp
